...
class Empresa extends ActiveRecord {
    ...
    protected function initialize() {        
        ...
        $this->validates_presence_of('razon_social', 'message: Ingresa el nombre de la organización');
        $this->validates_presence_of('representante_legal', 'message: Ingresa el nombre del propietario');
        $this->validates_presence_of('nuip', 'message: Ingresa el No. Usuario del Representante legal.');
